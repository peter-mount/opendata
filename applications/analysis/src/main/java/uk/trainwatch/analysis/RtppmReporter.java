...
public class RtppmReporter {
    ...
    public static void setup(RabbitConnection rabbitmq) throws IOException {
        ...
        Consumer<RTPPMDataMsg> statisticRecorder = RateMonitor.log(RtppmReporter.class,
                "rtppm messages recorded");

        Consumer<RTPPMDataMsg> consumer = recorder.andThen(statisticRecorder);
