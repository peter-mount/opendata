...
<div>
    <table class="wikitable" width="100%">
        <caption>Timetabled Departures</caption>
        <tr>
    ...
    <strong>Note:</strong> This is the timetabled departures, not what's actually happening.
    View todays full <a href="/timetable/station/${location.tiploc}">timetable</a> for ${location.location}.
</div>